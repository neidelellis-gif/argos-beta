...
const DailyApiContract = Object.freeze({
    version: "1.5",
    compatibleVersions: Object.freeze(["1.0", "1.1", "1.2", "1.3", "1.4", "1.5"]),
    ...
    isCompatibleResponse(payload) {
        ...
        return typeof payload.generated_at === "string"
            ...
            && (!["1.2", "1.3", "1.4", "1.5"].includes(payload.contract_version) || Array.isArray(payload.impact_assessments))
            && (!["1.3", "1.4", "1.5"].includes(payload.contract_version) || Array.isArray(payload.decision_contexts))
