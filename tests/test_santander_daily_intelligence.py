...
def test_returns_none_when_santander_is_absent():
...
def test_filters_only_jolika_santander_positions():
    intelligence_service, provider = service(
        {
            "AAA": history(
                "AAA",
    ...
    assert result.structural.institution == "Santander"
...
def test_builds_structural_quantitative_and_operational_layers():
    ...
    assert result.structural.institution == "Santander"
    assert result.quantitative.institution == "Santander"
    assert result.operational.institution == "Santander"
